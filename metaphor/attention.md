...
## A
> *Nietzsche’s **The Birth of Tragedy** celebrates the tension and interplay between the Apollonian (order, [form](https://en.wikipedia.org/wiki/Pierre-Auguste_Renoir), `structure`) and the Dionysian (chaos, ecstasy, `dynamic` [flow](https://abikesa.github.io/jean-renoir/)), with **music as the primordial medium** where this tension lives and breathes.*               
>                
